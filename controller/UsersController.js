...
let UserControl = new Controller('../service/UsersService');

UserControl.getRouteur().post('/login', (request,response)=> {
...
module.exports = UserControl.getRouteur();
// module.exports = UserControl.getService();
